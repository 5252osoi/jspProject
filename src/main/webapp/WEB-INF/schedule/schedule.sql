...
insert into schedule values (default,'gugus','2023-11-11','모임','빼빼로데이 모임-사창사거리');
insert into schedule values (default,'gugus','2023-11-15','여행','주말 여행계획');
insert into schedule values (default,'gugus','2023-11-22','학습','프로젝트 점검');
