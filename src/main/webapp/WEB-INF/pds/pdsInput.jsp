...
<head>
	...
	<script>
		...
		function fileBoxAppend(){
			...
			fileBox+='<input type="button" value="삭제" onclick="deleteBox('+cnt+')" class="btn btn-danger btn-sm form-control mb-2 ml-2" style="width:10%"/>';
			fileBox+='</div>';
...
<jsp:include page="/include/header.jsp"/>
	...
	<div class="container">
		<form name="myform" method="post" action="pdsInputOk.pds" enctype="multipart/form-data">
			<h2 class=" text-center">자료 업로드</h2>
			<br/>
			<div>
			...
			<div class="mb-2">
				내용 : <textarea rows="10" name="content" id="content" placeholder="설명을 입력하세요" class="form-control"></textarea>
			</div>
			<div class="mb-2">
				분류 :
