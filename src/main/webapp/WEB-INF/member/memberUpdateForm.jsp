        ...
        <c:set var="email" value="${fn:split(vo.email,'@')}"/> 
          ...
          <div class="input-group-append">
            <select name="email2" class="custom-select">
              <option value="naver.com" ${email[0]=='naver.com'?'selected':''}>naver.com</option>
              <option value="hanmail.net" ${email[0]=='hanmail.net'?'selected':''}>hanmail.net</option>
              <option value="hotmail.com" ${email[0]=='hotmail.com'?'selected':''}>hotmail.com</option>
              <option value="gmail.com" ${email[0]=='gmail.com'?'selected':''}>gmail.com</option>
              <option value="nate.com" ${email[0]=='nate.com'?'selected':''}>nate.com</option>
              <option value="yahoo.com" ${email[0]=='yahoo.com'?'selected':''}>yahoo.com</option>
            </select>
          </div>
        </div>
    </div>
