...
<jsp:include page="/include/header.jsp"/>
	...
	<form name="myform" method="post" action="memberPwdCheckOk.mem">
		<div>(회원 정보 수정을 하시려면 기본 비밀번호를 확인합니다.)</div>
		<table class="table table-bordered">
	  	  <tr>
	  	    <td colspan="2" class="text-center"><h2>비밀번호 확인</h2></td>
	  	  </tr>
	  	  <tr>
	  	    <th>비밀번호</th>
	  	  ...
	  	  <tr>
	  	    <td colspan="2" class="text-center">
	  	      ...
	  	      <input type="submit" value="개인정보변경" class="btn btn-success mr-2" />
	...
	<div id="pwdDemo" >
		<form>
			<table class="table table-borderless">
			    ...
			    <tr>
			      <td colspan="2"><input type="button" value="비밀번호변경하기" onclick="pwdReCheckOk()" class="form-control"/></td>
			    </tr>
			</table>
		</form>
	</div>
