	...
	<div class="container" >
		<form name="loginForm" method="post" action="${pageContext.request.contextPath}/j1030/loginOk4">
			<table class="table-bordered">
				<tr>
					<th colspan="2" class="text-center"><h2>회 원 로 그 인</h2></th>
				</tr>
				<tr>
					<th>아이디</th>
				...
				<tr>
					<th>닉네임</th>
					<td><input type="text" name="nickName" id="nickName" value="관리맨" class="form-control" required/></td>
				</tr>
				<tr>
					<th colspan="2" class="text-center">
						<input type="submit" value="로그인" class="btn btn-info mr-3">
