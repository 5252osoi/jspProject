...
<!-- 		<form name="myform" method="get" action="test1Ok.jsp"> -->		
			...
			<div>
				<input type="submit" value ="전송(submit)" class="btn btn-success form-control mt-3"/>
				<input type="button" value ="전송(button)" onclick="location.href='test1Ok.jsp?name=홍길동&age=25';" class="btn btn-info form-control mt-3"/>
			</div>
		</form>
	</div>
	<p><br/></p>
