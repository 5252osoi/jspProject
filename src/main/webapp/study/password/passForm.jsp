...
<jsp:include page="/include/header.jsp"/>
		  	...
		  	<table class="table table-bordered">
		  	  ...
		  	  <tr>
		  	    <td colspan="2" class="text-center">
		  	      ...
		  	      <input type="reset" value="다시입력" class="btn btn-info mr-3" />
		  	    </td>
		  	  </tr>
		  	</table>
  ...
  <pre>
  	...
  	단방향식 암호화 기법, 암호학적 해시함수들의 모임이다.
  	일반적으로 복호화 할 수 없도록 만든 알고리즘으로, SHA-2라고 한다.
  	해시함수가 출력되는 암축된 문장을 다이제스트(Digest)라고 하는데,
  	이 때 SHA-2가 생성해주는 다이제스트의 출력길이는 256,512bit가 있다.
  	여기서 256bit의 출력길이를 갖는 SHA-2암호화가 'SHA-256 암호화 방식'이다.
